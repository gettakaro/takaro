...
import { UnControlledSlider, styled } from '@takaro/lib-components';
...
export function RangeWidget<T = unknown, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>({
  disabled,
  rawErrors = [],
  required,
  schema,
