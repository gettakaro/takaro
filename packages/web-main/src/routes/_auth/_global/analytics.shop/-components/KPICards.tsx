...
const KPICard = styled(Card)<{ $trend?: 'positive' | 'negative' | 'neutral' }>`
  ...
  background: ${({ theme, $trend }) => 
    $trend === 'positive' ? `linear-gradient(135deg, ${theme.colors.background}, rgba(60, 205, 106, 0.1))` :
    $trend === 'negative' ? `linear-gradient(135deg, ${theme.colors.background}, rgba(239, 68, 68, 0.1))` :
...
const KPIChange = styled.div<{ $trend: 'positive' | 'negative' | 'neutral' }>`
  ...
  color: ${({ theme, $trend }) => 
    $trend === 'positive' ? theme.colors.success :
    $trend === 'negative' ? theme.colors.error :
