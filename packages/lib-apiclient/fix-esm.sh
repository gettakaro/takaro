...
# This script is used to fix the ESM imports in the generated TypeScript files.
# This is required because the generator does not add the .js extension to the imports.
