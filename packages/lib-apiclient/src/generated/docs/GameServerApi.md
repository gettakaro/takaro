...
const { status, data } = await apiInstance.gameServerControllerBanPlayer(
    gameServerId,
    playerId,
    banPlayerInputDTO
);
...
const { status, data } = await apiInstance.gameServerControllerCreate(
    gameServerCreateDTO
);
```
...
const { status, data } = await apiInstance.gameServerControllerExecuteCommand(
    id,
    commandExecuteInputDTO
);
```
...
const { status, data } = await apiInstance.gameServerControllerGetImport(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerGetJob(
    type,
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerGetMapInfo(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerGetMapTile(
    id,
    x,
    y,
    z
...
const { status, data } = await apiInstance.gameServerControllerGetOne(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerGetPlayers(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerGiveItem(
    gameServerId,
    playerId,
    giveItemInputDTO
);
...
const { status, data } = await apiInstance.gameServerControllerKickPlayer(
    gameServerId,
    playerId,
    kickPlayerInputDTO
);
...
const { status, data } = await apiInstance.gameServerControllerListBans(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerRemove(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerSearch(
    gameServerSearchInputDTO
);
```
...
const { status, data } = await apiInstance.gameServerControllerSendMessage(
    id,
    messageSendInputDTO
);
```
...
const { status, data } = await apiInstance.gameServerControllerShutdown(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerTestReachability(
    gameServerTestReachabilityInputDTO
);
```
...
const { status, data } = await apiInstance.gameServerControllerTestReachabilityForId(
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerTriggerJob(
    type,
    id
);
```
...
const { status, data } = await apiInstance.gameServerControllerUnbanPlayer(
    gameServerId,
    playerId
);
```
...
const { status, data } = await apiInstance.gameServerControllerUpdate(
    id,
    gameServerUpdateDTO
);
```
