...
const { status, data } = await apiInstance.moduleControllerCreate(
    moduleCreateAPIDTO
);
```
...
const { status, data } = await apiInstance.moduleControllerExport(
    id,
    moduleExportOptionsDTO
);
```
...
const { status, data } = await apiInstance.moduleControllerGetOne(
    id
);
```
...
const { status, data } = await apiInstance.moduleControllerGetTags(
    id,
    page,
    limit
);
...
const { status, data } = await apiInstance.moduleControllerImport(
    body
);
```
...
const { status, data } = await apiInstance.moduleControllerRemove(
    id
);
```
...
const { status, data } = await apiInstance.moduleControllerSearch(
    moduleSearchInputDTO
);
```
...
const { status, data } = await apiInstance.moduleControllerUpdate(
    id,
    moduleUpdateDTO
);
```
...
const { status, data } = await apiInstance.moduleInstallationsControllerGetModuleInstallation(
    moduleId,
    gameServerId
);
```
...
const { status, data } = await apiInstance.moduleInstallationsControllerInstallModule(
    installModuleDTO
);
```
...
const { status, data } = await apiInstance.moduleInstallationsControllerUninstallModule(
    moduleId,
    gameServerId
);
```
...
const { status, data } = await apiInstance.moduleVersionControllerGetModuleVersion(
    id
);
```
...
const { status, data } = await apiInstance.moduleVersionControllerSearchVersions(
    moduleVersionSearchInputDTO
);
```
...
const { status, data } = await apiInstance.moduleVersionControllerTagVersion(
    moduleVersionCreateAPIDTO
);
```
