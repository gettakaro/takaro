...
| [**eventControllerExport**](#eventcontrollerexport)                         | **POST** /event/export                  | Export events to CSV |
...
const { status, data } = await apiInstance.eventControllerExport(eventSearchInputDTO);
```
