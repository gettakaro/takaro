...
const { status, data } = await apiInstance.functionControllerCreate(
    functionCreateDTO
);
```
...
const { status, data } = await apiInstance.functionControllerGetOne(
    id
);
```
...
const { status, data } = await apiInstance.functionControllerRemove(
    id
);
```
...
const { status, data } = await apiInstance.functionControllerSearch(
    functionSearchInputDTO
);
```
...
const { status, data } = await apiInstance.functionControllerUpdate(
    id,
    functionUpdateDTO
);
```
