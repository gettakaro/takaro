...
const { status, data } = await apiInstance.shopCategoryControllerBulkAssign(
    shopCategoryBulkAssignDTO
);
```
...
const { status, data } = await apiInstance.shopCategoryControllerCreate(
    shopCategoryCreateDTO
);
```
...
const { status, data } = await apiInstance.shopCategoryControllerGetOne(
    id
);
```
...
const { status, data } = await apiInstance.shopCategoryControllerMove(
    id,
    shopCategoryMoveDTO
);
```
...
const { status, data } = await apiInstance.shopCategoryControllerRemove(
    id
);
```
...
const { status, data } = await apiInstance.shopCategoryControllerSearch(
    shopCategorySearchInputDTO
);
```
...
const { status, data } = await apiInstance.shopCategoryControllerUpdate(
    id,
    shopCategoryUpdateDTO
);
```
