...
const { status, data } = await apiInstance.commandControllerCreate(
    commandCreateDTO
);
```
...
const { status, data } = await apiInstance.commandControllerCreateArgument(
    commandArgumentCreateDTO
);
```
...
const { status, data } = await apiInstance.commandControllerGetExecutions(
    id,
    success,
    eventSearchInputDTO
);
...
const { status, data } = await apiInstance.commandControllerGetOne(
    id
);
```
...
const { status, data } = await apiInstance.commandControllerRemove(
    id
);
```
...
const { status, data } = await apiInstance.commandControllerRemoveArgument(
    id
);
```
...
const { status, data } = await apiInstance.commandControllerSearch(
    commandSearchInputDTO
);
```
...
const { status, data } = await apiInstance.commandControllerTrigger(
    id,
    commandTriggerDTO
);
```
...
const { status, data } = await apiInstance.commandControllerUpdate(
    id,
    commandUpdateDTO
);
```
...
const { status, data } = await apiInstance.commandControllerUpdateArgument(
    id,
    commandArgumentUpdateDTO
);
```
