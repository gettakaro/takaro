...
const { status, data } = await apiInstance.cronJobControllerCreate(
    cronJobCreateDTO
);
```
...
const { status, data } = await apiInstance.cronJobControllerGetExecutions(
    id,
    success,
    eventSearchInputDTO
);
...
const { status, data } = await apiInstance.cronJobControllerGetOne(
    id
);
```
...
const { status, data } = await apiInstance.cronJobControllerRemove(
    id
);
```
...
const { status, data } = await apiInstance.cronJobControllerSearch(
    cronJobSearchInputDTO
);
```
...
const { status, data } = await apiInstance.cronJobControllerTrigger(
    cronJobTriggerDTO
);
```
...
const { status, data } = await apiInstance.cronJobControllerUpdate(
    id,
    cronJobUpdateDTO
);
```
