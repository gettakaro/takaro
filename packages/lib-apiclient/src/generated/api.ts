 ...
 *
 * The version of the OpenAPI document: development - a2e5f4184841f6f3c71c8dc263a5e1bda8c25e12
...
export const BanApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    banControllerDelete: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/ban/{id}/delete`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    banControllerGetOne: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/ban/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
  ...
  return {
    ...
    async banControllerCreate(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['BanApi.banControllerCreate']?.[localVarOperationServerIndex]?.url;
    ...
    async banControllerDelete(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BanApi.banControllerDelete']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async banControllerGetOne(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BanApi.banControllerGetOne']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async banControllerSearch(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BanApi.banControllerSearch']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async banControllerUpdate(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BanApi.banControllerUpdate']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export class BanApi extends BaseAPI {
  ...
  public banControllerCreate(banCreateDTO?: BanCreateDTO, options?: RawAxiosRequestConfig) {
    return BanApiFp(this.configuration)
