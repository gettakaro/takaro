...
export const PlayerOnGameServerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        playerOnGameServerControllerPing: async (gameserverId: string, playerId: string, playerOnGameServerStatsInputDTO?: PlayerOnGameServerStatsInputDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'gameserverId' is not null or undefined
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(playerOnGameServerStatsInputDTO, localVarRequestOptions, configuration)
...
export const PlayerOnGameServerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async playerOnGameServerControllerPing(gameserverId: string, playerId: string, playerOnGameServerStatsInputDTO?: PlayerOnGameServerStatsInputDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.playerOnGameServerControllerPing(gameserverId, playerId, playerOnGameServerStatsInputDTO, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['PlayerOnGameServerApi.playerOnGameServerControllerPing']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         *  Required permissions: `READ_PLAYERS`
...
export const PlayerOnGameServerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        playerOnGameServerControllerPing(gameserverId: string, playerId: string, playerOnGameServerStatsInputDTO?: PlayerOnGameServerStatsInputDTO, options?: any): AxiosPromise<void> {
            return localVarFp.playerOnGameServerControllerPing(gameserverId, playerId, playerOnGameServerStatsInputDTO, options).then((request) => request(axios, basePath));
        },
        /**
         *  Required permissions: `READ_PLAYERS`
         * @summary Search
...
export class PlayerOnGameServerApi extends BaseAPI {
     ...
     * @memberof PlayerOnGameServerApi
     */
    public playerOnGameServerControllerPing(gameserverId: string, playerId: string, playerOnGameServerStatsInputDTO?: PlayerOnGameServerStatsInputDTO, options?: RawAxiosRequestConfig) {
        return PlayerOnGameServerApiFp(this.configuration).playerOnGameServerControllerPing(gameserverId, playerId, playerOnGameServerStatsInputDTO, options).then((request) => request(this.axios, this.basePath));
    }
