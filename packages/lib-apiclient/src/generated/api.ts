...
export const ModuleApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    moduleInstallationsControllerGetModuleInstallation: async (
      ...
      const localVarPath = `/module/installation/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    moduleVersionControllerExport: async (
     ...
     * @throws {RequiredError}
     */
    moduleVersionControllerImport: async (
...
export const ModuleApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async moduleVersionControllerExport(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.moduleVersionControllerExport(
     ...
     * @throws {RequiredError}
     */
    async moduleVersionControllerImport(
      builtinModule?: BuiltinModule,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
    ...
    async moduleVersionControllerRemoveVersion(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ModuleApi.moduleVersionControllerRemoveVersion']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async moduleVersionControllerUpdateVersion(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ModuleApi.moduleVersionControllerUpdateVersion']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
