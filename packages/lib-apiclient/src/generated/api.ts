...
export const GameServerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Get all module installations for a gameserver<br> OperationId: `GameServerControllerGetInstalledModules`
        ...
        /**
         * Get a module installation by id<br> OperationId: `GameServerControllerGetModuleInstallation`
        ...
        /**
         * Install a module on a gameserver. If the module is already installed, it will be updated. Required permissions: `MANAGE_GAMESERVERS`<br> OperationId: `GameServerControllerInstallModule`
        ...
        /**
         * Uninstall a module from a gameserver. This will not delete the module from the database. Required permissions: `MANAGE_GAMESERVERS`<br> OperationId: `GameServerControllerUninstallModule`
...
export const GameServerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async gameServerControllerGetInstalledModules(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModuleInstallationOutputArrayDTOAPI>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GameServerApi.gameServerControllerGetInstalledModules']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get map metadata for Leaflet<br> OperationId: `GameServerControllerGetMapInfo`
        ...
        async gameServerControllerGetModuleInstallation(gameServerId: string, moduleId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModuleInstallationOutputDTOAPI>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GameServerApi.gameServerControllerGetModuleInstallation']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetch a gameserver by id<br> OperationId: `GameServerControllerGetOne`
        ...
        async gameServerControllerInstallModule(gameServerId: string, moduleId: string, moduleInstallDTO?: ModuleInstallDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModuleInstallationOutputDTOAPI>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GameServerApi.gameServerControllerInstallModule']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Kick a player from a gameserver. Requires gameserver to be online and reachable. Required permissions: `MANAGE_GAMESERVERS`<br> OperationId: `GameServerControllerKickPlayer`
        ...
        async gameServerControllerUninstallModule(gameServerId: string, moduleId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModuleInstallationOutputDTOAPI>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GameServerApi.gameServerControllerUninstallModule']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update a gameserver Required permissions: `MANAGE_GAMESERVERS`<br> OperationId: `GameServerControllerUpdate`
...
export const ModuleApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         *  Required permissions: `MANAGE_MODULES`<br> OperationId: `ModuleControllerCreate`
         * @summary Create
        ...
        /**
         *  Required permissions: `READ_MODULES`<br> OperationId: `ModuleControllerExport`
         * @summary Export
         * @param {string} id 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
        ...
        /**
         *  Required permissions: `MANAGE_MODULES`<br> OperationId: `ModuleControllerImport`
         * @summary Import
        ...
        /**
         *  Required permissions: `MANAGE_MODULES`<br> OperationId: `ModuleControllerRemove`
         * @summary Remove
         * @param {string} id 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
        ...
        /**
         *  Required permissions: `MANAGE_MODULES`<br> OperationId: `ModuleControllerUpdate`
         * @summary Update
         * @param {string} id 
