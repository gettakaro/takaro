...
export type EntitySearchInputAllowedFiltersTypeEnum =
  (typeof EntitySearchInputAllowedFiltersTypeEnum)[keyof typeof EntitySearchInputAllowedFiltersTypeEnum];
...
export type EntitySearchInputDTOSortDirectionEnum =
  (typeof EntitySearchInputDTOSortDirectionEnum)[keyof typeof EntitySearchInputDTOSortDirectionEnum];
 ...
 *
 * @export
 * @interface TakaroEventPlayerBanned
 */
export interface TakaroEventPlayerBanned {
  /**
   *
   * @type {string}
 ...
 *
 * @export
 * @interface TakaroEventPlayerUnbanned
 */
export interface TakaroEventPlayerUnbanned {
  /**
   *
   * @type {boolean}
   * @memberof TakaroEventPlayerUnbanned
   */
  isGlobal: boolean;
  /**
   *
...
export const EntityApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    entityControllerFindOne: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/entities/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    entityControllerSearch: async (
      entitySearchInputDTO?: EntitySearchInputDTO,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const EntityApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async entityControllerFindOne(
      id: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EntityOutputDTOAPI>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.entityControllerFindOne(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['EntityApi.entityControllerFindOne']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async entityControllerSearch(
      entitySearchInputDTO?: EntitySearchInputDTO,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EntityOutputArrayDTOAPI>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.entityControllerSearch(entitySearchInputDTO, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['EntityApi.entityControllerSearch']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const EntityApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    entityControllerSearch(
      entitySearchInputDTO?: EntitySearchInputDTO,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<EntityOutputArrayDTOAPI> {
      return localVarFp
        .entityControllerSearch(entitySearchInputDTO, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class EntityApi extends BaseAPI {
  ...
  public entityControllerFindOne(id: string, options?: RawAxiosRequestConfig) {
    return EntityApiFp(this.configuration)
      .entityControllerFindOne(id, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const MetaApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async metaGetRoot(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MetaApi.metaGetRoot']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const TrackingApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    trackingControllerGetBoundingBoxPlayers: async (
      boundingBoxSearchInputDTO?: BoundingBoxSearchInputDTO,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    trackingControllerGetPlayerInventoryHistory: async (
      playerInventoryHistoryInputDTO?: PlayerInventoryHistoryInputDTO,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    trackingControllerGetPlayerMovementHistory: async (
      playerMovementHistoryInputDTO?: PlayerMovementHistoryInputDTO,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    trackingControllerGetPlayersByItem: async (
      playersByItemInputDTO?: PlayersByItemInputDTO,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    trackingControllerGetRadiusPlayers: async (
      radiusSearchInputDTO?: RadiusSearchInputDTO,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const TrackingApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async trackingControllerGetBoundingBoxPlayers(
      boundingBoxSearchInputDTO?: BoundingBoxSearchInputDTO,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlayerLocationArrayOutputDTOAPI>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.trackingControllerGetBoundingBoxPlayers(
        boundingBoxSearchInputDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TrackingApi.trackingControllerGetBoundingBoxPlayers']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async trackingControllerGetPlayerInventoryHistory(
      playerInventoryHistoryInputDTO?: PlayerInventoryHistoryInputDTO,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlayerInventoryArrayOutputDTOAPI>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.trackingControllerGetPlayerInventoryHistory(
        playerInventoryHistoryInputDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TrackingApi.trackingControllerGetPlayerInventoryHistory']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async trackingControllerGetPlayerMovementHistory(
      playerMovementHistoryInputDTO?: PlayerMovementHistoryInputDTO,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlayerLocationArrayOutputDTOAPI>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.trackingControllerGetPlayerMovementHistory(
        playerMovementHistoryInputDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TrackingApi.trackingControllerGetPlayerMovementHistory']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async trackingControllerGetPlayersByItem(
      playersByItemInputDTO?: PlayersByItemInputDTO,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlayerItemHistoryArrayOutputDTOAPI>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.trackingControllerGetPlayersByItem(
        playersByItemInputDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TrackingApi.trackingControllerGetPlayersByItem']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async trackingControllerGetRadiusPlayers(
      radiusSearchInputDTO?: RadiusSearchInputDTO,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlayerLocationArrayOutputDTOAPI>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.trackingControllerGetRadiusPlayers(
        radiusSearchInputDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TrackingApi.trackingControllerGetRadiusPlayers']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const TrackingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    trackingControllerGetBoundingBoxPlayers(
      boundingBoxSearchInputDTO?: BoundingBoxSearchInputDTO,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PlayerLocationArrayOutputDTOAPI> {
      return localVarFp
        .trackingControllerGetBoundingBoxPlayers(boundingBoxSearchInputDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get inventory changes for a player between two timestamps   Required permissions: `READ_PLAYERS`<br> OperationId: `TrackingControllerGetPlayerInventoryHistory`
    ...
    trackingControllerGetPlayerInventoryHistory(
      playerInventoryHistoryInputDTO?: PlayerInventoryHistoryInputDTO,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PlayerInventoryArrayOutputDTOAPI> {
      return localVarFp
        .trackingControllerGetPlayerInventoryHistory(playerInventoryHistoryInputDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get movement history for players within date bounds   Required permissions: `READ_PLAYERS`<br> OperationId: `TrackingControllerGetPlayerMovementHistory`
    ...
    trackingControllerGetPlayerMovementHistory(
      ...
      return localVarFp
        .trackingControllerGetPlayerMovementHistory(playerMovementHistoryInputDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Find all players who have had a specific item in their inventory   Required permissions: `READ_PLAYERS`<br> OperationId: `TrackingControllerGetPlayersByItem`
    ...
    trackingControllerGetPlayersByItem(
      playersByItemInputDTO?: PlayersByItemInputDTO,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PlayerItemHistoryArrayOutputDTOAPI> {
      return localVarFp
        .trackingControllerGetPlayersByItem(playersByItemInputDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Find all players within a spherical area from a center point   Required permissions: `READ_PLAYERS`<br> OperationId: `TrackingControllerGetRadiusPlayers`
    ...
    trackingControllerGetRadiusPlayers(
      ...
      return localVarFp
        .trackingControllerGetRadiusPlayers(radiusSearchInputDTO, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class TrackingApi extends BaseAPI {
   ...
   */
  public trackingControllerGetBoundingBoxPlayers(
    boundingBoxSearchInputDTO?: BoundingBoxSearchInputDTO,
    options?: RawAxiosRequestConfig,
  ) {
    return TrackingApiFp(this.configuration)
      .trackingControllerGetBoundingBoxPlayers(boundingBoxSearchInputDTO, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof TrackingApi
   */
  public trackingControllerGetPlayerInventoryHistory(
    playerInventoryHistoryInputDTO?: PlayerInventoryHistoryInputDTO,
    options?: RawAxiosRequestConfig,
  ) {
    return TrackingApiFp(this.configuration)
   ...
   * @memberof TrackingApi
   */
  public trackingControllerGetPlayerMovementHistory(
    playerMovementHistoryInputDTO?: PlayerMovementHistoryInputDTO,
    options?: RawAxiosRequestConfig,
  ) {
    return TrackingApiFp(this.configuration)
   ...
   * @memberof TrackingApi
   */
  public trackingControllerGetPlayersByItem(
    playersByItemInputDTO?: PlayersByItemInputDTO,
    options?: RawAxiosRequestConfig,
  ) {
    return TrackingApiFp(this.configuration)
   ...
   * @memberof TrackingApi
   */
  public trackingControllerGetRadiusPlayers(
    radiusSearchInputDTO?: RadiusSearchInputDTO,
    options?: RawAxiosRequestConfig,
  ) {
    return TrackingApiFp(this.configuration)
