...
export const ShopOrderApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        shopOrderControllerSearch: async (iTakaroQuery?: ITakaroQuery, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ShopOrderApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async shopOrderControllerSearch(iTakaroQuery?: ITakaroQuery, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShopOrderOutputArrayDTOAPI>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.shopOrderControllerSearch(iTakaroQuery, options);
            const index = configuration?.serverIndex ?? 0;
...
export const ShopOrderApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        shopOrderControllerSearch(iTakaroQuery?: ITakaroQuery, options?: any): AxiosPromise<ShopOrderOutputArrayDTOAPI> {
            return localVarFp.shopOrderControllerSearch(iTakaroQuery, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ShopOrderApi extends BaseAPI {
     ...
     * @memberof ShopOrderApi
     */
    public shopOrderControllerSearch(iTakaroQuery?: ITakaroQuery, options?: RawAxiosRequestConfig) {
        return ShopOrderApiFp(this.configuration).shopOrderControllerSearch(iTakaroQuery, options).then((request) => request(this.axios, this.basePath));
    }
}
