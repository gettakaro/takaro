...
export const RoleApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        roleControllerGetMembers: async (id: string, gameServerId?: string, page?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('roleControllerGetMembers', 'id', id)
            const localVarPath = `/role/{id}/members`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const RoleApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async roleControllerGetMembers(id: string, gameServerId?: string, page?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RoleMembersOutputDTOAPI>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.roleControllerGetMembers(id, gameServerId, page, limit, options);
            const index = configuration?.serverIndex ?? 0;
...
export const RoleApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        roleControllerGetMembers(id: string, gameServerId?: string, page?: number, limit?: number, options?: any): AxiosPromise<RoleMembersOutputDTOAPI> {
            return localVarFp.roleControllerGetMembers(id, gameServerId, page, limit, options).then((request) => request(axios, basePath));
        },
        /**
         *  Required permissions: `READ_ROLES`
         * @summary Get one
...
export class RoleApi extends BaseAPI {
     ...
     * @memberof RoleApi
     */
    public roleControllerGetMembers(id: string, gameServerId?: string, page?: number, limit?: number, options?: RawAxiosRequestConfig) {
        return RoleApiFp(this.configuration).roleControllerGetMembers(id, gameServerId, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
