...
export const TrackingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        trackingControllerGetBoundingBoxPlayers: async (boundingBoxSearchInputDTO?: BoundingBoxSearchInputDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/tracking/gameserver/tracking/location/box`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        trackingControllerGetPlayerMovementHistory: async (playerMovementHistoryInputDTO?: PlayerMovementHistoryInputDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/tracking/gameserver/tracking/location`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        trackingControllerGetRadiusPlayers: async (radiusSearchInputDTO?: RadiusSearchInputDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/tracking/gameserver/tracking/location/radius`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
