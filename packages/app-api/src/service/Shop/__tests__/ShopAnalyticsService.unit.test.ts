...
describe('ShopAnalyticsService', () => {
  ...
  describe('getAnalytics', () => {
    ...
    it('should handle cache errors gracefully', async () => {
      ...
      sandbox.stub(service as any, 'calculateRevenue').resolves({
        timeSeries: [], byHour: [], total: 1000, growth: 11.1
      });
      sandbox.stub(service as any, 'calculateProducts').resolves({
        topSellingProducts: [], topSellingCategories: [], underperformingProducts: [], outOfStockProducts: []
      });
      sandbox.stub(service as any, 'calculateOrders').resolves({
        statusDistribution: [], recentOrders: [], 
        timeToFulfillment: { average: 0, min: 0, max: 0 }, returnRate: 0
      });
      sandbox.stub(service as any, 'calculateCustomers').resolves({
        newCustomers: 2, returningCustomers: 8, topBuyers: [], churnRate: 0, segments: []
      });
      sandbox.stub(service as any, 'generateInsights').resolves([]);
  ...
  describe('Date Range Handling', () => {
    it('should handle different date formats', async () => {
      ...
      sandbox.stub(service as any, 'calculateRevenue').resolves({
        timeSeries: [], byHour: [], total: 0, growth: 0
      });
      sandbox.stub(service as any, 'calculateProducts').resolves({
        topSellingProducts: [], topSellingCategories: [], underperformingProducts: [], outOfStockProducts: []
      });
      ...
      sandbox.stub(service as any, 'calculateCustomers').resolves({
        newCustomers: 0, returningCustomers: 0, topBuyers: [], churnRate: 0, segments: []
      });
      sandbox.stub(service as any, 'generateInsights').resolves([]);
  ...
  describe('Multi-server Filtering', () => {
    ...
    it('should handle undefined gameServerIds as all servers', async () => {
      ...
      sandbox.stub(service as any, 'calculateRevenue').resolves({
        timeSeries: [], byHour: [], total: 5000, growth: 11.1
      });
      sandbox.stub(service as any, 'calculateProducts').resolves({
        topSellingProducts: [], topSellingCategories: [], underperformingProducts: [], outOfStockProducts: []
      });
      ...
      sandbox.stub(service as any, 'calculateCustomers').resolves({
        newCustomers: 10, returningCustomers: 40, topBuyers: [], churnRate: 5, segments: []
      });
      sandbox.stub(service as any, 'generateInsights').resolves([]);
