...
Inside a Function, you will have access to data about the event that triggered it, as well as the ability to interact with the game server. The Function will come pre-loaded with an API client (`lib-apiclient`).
