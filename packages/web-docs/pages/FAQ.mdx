...
import roleEditPage from '../assets/images/faq/roles-module-permissions.png';
...
<Image src={roleEditPage} alt="Takaro role editing page" width={500} height={250} />
...
We know there is stuff to be added to the builtin modules, and we are working on that. If you have any suggestions, please let us know on Discord!
