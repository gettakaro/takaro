...
Takaro provides a set of builtin modules. These are created and maintained by the Takaro team. You can configure and install these without having to write any code.
